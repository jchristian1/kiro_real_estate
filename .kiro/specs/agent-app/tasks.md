...
- [x] 10. Settings and reports backend
  ...
  - [x] 10.7 Write property test for credential never plaintext
...
- [x] 12. React app scaffold and routing
...
- [x] 14. Dashboard and leads inbox frontend
...
- [x] 17. Mobile-first CSS audit and polish
...
- [x] 18. Integration and security tests
