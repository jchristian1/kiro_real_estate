...
import { GMAIL_ERROR_MESSAGES } from '@/models/agent';

interface Step2GmailProps { goBack: () => void; }

export const Step2Gmail: React.FC<Step2GmailProps> = ({ goBack }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(GMAIL_ERROR_MESSAGES[raw] || raw);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{ background: t.bgCard, border: `1px solid ${t.border}`, borderRadius: 22, padding: '36px 32px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {success && (
          <div style={{ marginBottom: 16, padding: '10px 14px', background: t.greenBg, border: `1px solid ${t.red}30`, borderRadius: 9, fontSize: 13, color: t.green }}>
