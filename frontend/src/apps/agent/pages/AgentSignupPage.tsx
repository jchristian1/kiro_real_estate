/**
 * Agent Signup Page — redirects to onboarding after account creation.
 */
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 21, fontWeight: 700, color: t.text, letterSpacing: '-0.5px' }}>Create Account</div>
          <div style={{ fontSize: 13, color: t.textMuted, marginTop: 4 }}>Start your agent setup</div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          {[
            ...
            { field: 'confirm', label: 'Confirm Password', type: 'password', value: confirm, set: setConfirm },
        ...
        <div style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: t.textMuted }}>
          ...
          <Link to="/agent/login" style={{ color: t.accent, textDecoration: 'none', fontWeight: 500 }}>
            Sign in
          </Link>
        </div>
      </div>
