  ...
  return (
    <div style={{ maxWidth: 1000 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <span style={{ fontSize: 22, fontWeight: 700, color: t.text, letterSpacing: '-0.5px' }}>Agents</span>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              {agents.map((agent, i) => {
                ...
                return (
                  <tr key={agent.id} style={{ borderBottom: i < agents.length - 1 ? `1px solid ${t.border}` : 'none' }}>
